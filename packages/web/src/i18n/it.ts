...
export const it = {
  ...
  dimensioneTavola: 'Dimensione tavola',
  ...
  eroi: {
    ...
    scegliPerMulti: 'Eroi di {nome}',
    nessuno: 'Nessun eroe',
    scegli: 'Scegli eroe',
    cambia: 'Cambia',
    numero: 'Numero di eroi',
    numeroSpiega: 'Quanti eroi distinti gioca ogni clan (niente doppioni).',
    libero: 'Libero',
    selezionati: 'Selezionati {n}/{max}',
    conferma: 'Conferma',
