/**
 * La NUOVA tavola "grande" (codice 5) è la gigante con due lati in meno (29
 * caselle): il renderer deve centrarla dentro il canvas usando il raggio
 * geometrico 3, senza NaN, e con approdi ancorati sull'anello costiero.
 */
...
describe('grande (29 caselle) — geometria di resa', () => {
  it('tutte le 29 caselle stanno dentro il canvas e gli approdi sono finiti', () => {
